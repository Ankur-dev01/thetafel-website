...
test.describe('Pause / resume flow (D1.3)', () => {
  // Belt-and-braces: every test below also resets pause state itself before
  // returning, but D4.5 exists precisely because "also" isn't good enough —
  // a failure between the pause write and that cleanup used to skip it
  // entirely. This runs regardless of how any test in the file finished.
  test.afterAll(async () => {
